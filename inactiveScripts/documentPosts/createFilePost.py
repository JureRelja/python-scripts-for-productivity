...
def selectImg (browser, category, folder, imageOrder, imageFloat, imageFloatDefault, year):
    ...
    if imageOrder == 1:
        imageFloat = browser.find_element(By.ID, "jform_images_float_fulltext_chzn") #Finding the image float select
        optionsUl = imageFloat.find_elements(By.XPATH, "*")[-1].find_elements(By.XPATH, "*")[-1] #Finding the options ul
        ...
        imageFloat = browser.find_element(By.ID, "jform_images_float_intro_chzn") #Finding the image float select
        optionsUl = imageFloat.find_elements(By.XPATH, "*")[-1].find_elements(By.XPATH, "*")[-1] #Finding the options ul
