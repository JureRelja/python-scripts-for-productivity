...
def selectWebsite():
    ...
    inquirer.List('url',
                    ...
                    choices=['drnis.hr', 'djecji-vrtic-drnis.hr',  'ss-ivana-mestrovica-drnis.hr', 'ogsko.hr', 'zena-drnis.hr', 'vrtic-trogir.hr', 'pucko-otvoreno-uciliste-drnis.hr', 'promina.hr', "eko-promina.hr", 'gmd.hr', 'biskupija.hr', "nkdosk.hr", 'kalun.hr', 'gradskacistoca-drnis.hr',  'jvp-drnis.hr',  'komunalno-drustvo-biskupija.hr',  'lag-krka.hr', 'ljekarna-drnis.hr'],
                ),
    ]
