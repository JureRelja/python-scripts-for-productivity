...
tableExist = createHTMLTable(files=files, categoryName=selectedWebsite[1]["category"], date=date, downloads=downloads, tempFile=tempFile, selectedWebsite=selectedWebsite[0]["url"]) #Creating the HTML table
tempFile.seek(0)
